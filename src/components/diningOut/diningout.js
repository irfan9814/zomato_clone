...
import Collection from '../pageSections/collection/collection';
import ExploreSection from '../pageSections/exploreSection/exploreSection';
import { diningOut } from '../../data/dataDiningOut';
...
const DiningOut = () => {
  return (
    <div>
      ...
      <ExploreSection list={diningList}  collectionName='Trending dining restaurants in Agra' />
    </div>
  )
}
